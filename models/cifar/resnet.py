...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.bn2 = nn.BatchNorm2d(planes)
        self.conv3 = QuantConv2d(planes, planes * 4, kernel_size=1, bias=False)
...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_classes=1000):
        ...
        self.inplanes = 16
        self.conv1 = QuantConv2d(3, 16, kernel_size=3, padding=1, bias=False)
        self.bn1 = nn.BatchNorm2d(16)
        self.relu = nn.ReLU(inplace=True)
        self.layer1 = self._make_layer(block, 16, n)
        self.layer2 = self._make_layer(block, 32, n, stride=2)
        self.layer3 = self._make_layer(block, 64, n, stride=2)
        self.avgpool = QuantAvgPool2d(8)
        self.fc = QuantLinear(64 * block.expansion, num_classes)
